...
CONFIG_DIRECTORY = pathlib.PurePath(__file__).parent.parent.joinpath("config")
RESOURCES_DIRECTORY = pathlib.PurePath(__file__).parent.parent.joinpath("resources")
